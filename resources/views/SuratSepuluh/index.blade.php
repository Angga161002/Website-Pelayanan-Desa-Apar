                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">Data Surat Keterangan Kelakuan Baik
                                    </h6>
                                </div>
                            </div>
                                            ...
                                            @forelse ($surat_sepuluhs as $surat_sepuluhs)
                                                <tr>
                                                    ...
                                                    <td class="text-uppercase text-center  font-weight-bolder "><button
                                                            class="btn {{ $surat_sepuluhs->status == 1 ? 'btn-danger' : 'btn-success' }}"
                                                            disabled>{{ $surat_sepuluhs->status == 1 ? 'Belum Tercetak' : 'Sudah Tercetak' }}</button>
                                                    </td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_sepuluhs->nik }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        <a
                                                            href="{{ route('SuratSepuluh.show', ['SuratSepuluh' => $surat_sepuluhs->id]) }}">{{ $surat_sepuluhs->nama }}</a>
                                                    </td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_sepuluhs->keperluan }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_sepuluhs->keterangan }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_sepuluhs->no_hp }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        <a href="{{ route('SuratSepuluh.show', ['SuratSepuluh' => $surat_sepuluhs->id]) }}" title="Detail">
