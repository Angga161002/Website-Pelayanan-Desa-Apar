...
<head>
    ...
    <link rel="stylesheet"
        href="../assets/css/_all-skins.min.css">
    <!-- Google Font -->
    <link rel="stylesheet"
...
<body class="bg-light text-dark">
    ...
    <div class="container pt-4 ">
                ...
                <form action="{{ route('SuratDua.store') }}" method="POST">
                    ...
                    <div id="detail_permohonan_2" style="display:none;">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="tipe_sponsor" id="tipe_sponsor">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="lokasi_pindah" id="lokasi_pindah">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="alasan_pindah" id="alasan_pindah">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="jenis_kepindahan" id="jenis_kepindahan">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="statuskk_tidakpindah" id="statuskk_tidakpindah">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="statuskk_pindah" id="statuskk_pindah">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="keluarga_pindah" id="keluarga_pindah">
        ...
        <button type="submit" class="btn btn-success mb-3 mt-3" style="background-color: #28a745; border-color: #28a745;">Ajukan</button>
        </form>
    </div>
    </div>
    </div>
    ...
    <!-- Bootstrap WYSIHTML5 -->
    <script
        src="../assets/js/bootstrap3-wysihtml5.all.min.js">
    </script>
    <!-- Slimscroll -->
    <script
