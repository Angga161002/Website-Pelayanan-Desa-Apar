            ...
            <div class="col-12">
                <div class="pt-3 d-flex justify-content-end align-items-center">
                    ...
                    @if ($SuratEnam->status == 1)
                        <a href="{{ url('suratenam/admin/status/' . $SuratEnam->id) }}" class="btn btn-success mr-2">Sudah
                            Tercetak</a>
                    @else
                        <a href="{{ url('suratenam/admin/status/' . $SuratEnam->id) }}"" class="btn btn-danger mr-2">Belum
                            Tercetak</a>
                    @endif
