                                            ...
                                            @forelse ($surat_sebelas as $surat_sebelas)
                                                <tr>
                                                    ...
                                                    <td class="text-uppercase text-center  font-weight-bolder "><button
                                                            class="btn {{ $surat_sebelas->status == 1 ? 'btn-danger' : 'btn-success' }}"
                                                            disabled>{{ $surat_sebelas->status == 1 ? 'Belum Tercetak' : 'Sudah Tercetak' }}</button>
                                                    </td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_sebelas->nik }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        <a
                                                            href="{{ route('SuratSebelas.show', ['SuratSebelas' => $surat_sebelas->id]) }}">{{ $surat_sebelas->nama }}</a>
                                                    </td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_sebelas->keterangan }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_sebelas->no_hp }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        <a href="{{ route('SuratSebelas.show', ['SuratSebelas' => $surat_sebelas->id]) }}" title="Detail">
