            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Data Admin SPMDA</li>
                    </ol>
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">Data Admin SPMDA || <a
                                            href="{{ route('Admin.create') }}"><button type="submit"
                                                class="btn-sm btn-success">Tambah Admin </button></a></h6>
                                            ...
                                            @forelse ($admins as $admins)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <a
                                                            href="{{ route('Admin.show', ['Admin' => $admins->id]) }}">{{ $admins->username }}</a>
                                                    </td>
                                                    <td
                                                        class="text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $admins->no_hp }}</td>
