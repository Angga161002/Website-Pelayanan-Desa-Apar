            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Data Surat
                            Pendaftaran Peristiwa Kependudukan</li>
                    </ol>
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">Data Surat Pendaftaran Peristiwa
                                        Kependudukan</h6>
                                </div>
                            </div>
                                            ...
                                            @forelse ($suratsatus as $suratsatus)
                                                <tr>
                                                    ...
                                                    <td class="text-uppercase text-center  font-weight-bolder "><button
                                                            class="btn {{ $suratsatus->status == 1 ? 'btn-danger' : 'btn-success' }}"
                                                            disabled>{{ $suratsatus->status == 1 ? 'Belum Tercetak' : 'Sudah Tercetak' }}</button>
                                                    </td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $suratsatus->nik }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        <a
                                                            href="{{ route('SuratSatu.show', ['SuratSatu' => $suratsatus->id]) }}">{{ $suratsatus->nama }}</a>
                                                    </td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $suratsatus->permohonan }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $suratsatus->syarat }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $suratsatus->no_hp }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        <a href="{{ route('SuratSatu.show', ['SuratSatu' => $suratsatus->id]) }}" title="Detail">
                                                            <img src="../assets/img/eye-line-dark.svg">
                                                        </a>&nbsp
                                                        <a href="#" title="Delete">
                                                            <img src="../assets/img/delete-icon.svg">
                                                        </a>
                                                        {{-- <form action="{{ route('SuratSatu.destroy', ['SuratSatu' => $suratsatus->id]) }}" method="POST">
                                                            @method('DELETE') @csrf
