    ...
    <body class="bg-light text-dark">
        ...
        <div class="container pt-4 ">
            <div class="row">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-triangle-fill flex-shrink-0 mr-2" viewBox="0 0 16 16" role="img" aria-label="Warning:" style="margin-right: 10px">
                ...
                <h3>Surat Kematian</h3>
                    ...
                    <form action="{{ route('SuratLima.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <select class="form-select" name="sebab_kematian" id="sebab_kematian">
