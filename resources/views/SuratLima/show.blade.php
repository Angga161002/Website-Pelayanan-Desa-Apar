            ...
            <div class="col-12">
                <div class="pt-3 d-flex justify-content-end align-items-center">
                    ...
                    @if ($SuratLima->status == 1)
                        <a href="{{ url('suratlima/admin/status/' . $SuratLima->id) }}" class="btn btn-success mr-2">Sudah
                            Tercetak</a>
                    @else
                        <a href="{{ url('suratlima/admin/status/' . $SuratLima->id) }}"" class="btn btn-danger mr-2">Belum
                            Tercetak</a>
                    @endif
