            ...
            <div class="col-md-8 col-xl-6">
                ...
                <form action="{{ route('SuratDuabelas.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="status_ortu" id="status_ortu">
                            <option disabled selected>-- Status Orang Tua --</option>
                            <option value="MASIH HIDUP" {{ old('status_ortu') == 'MASIH_HIDUP' ? 'selected' : '' }}>
                                MASIH HIDUP
                            </option>
                            <option value="LUAR DESA/MENINGGAL"
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('nama_ortu') is-invalid @enderror"
                                id="nama_ortu" name="nama_ortu" placeholder="Nama Lengkap Orang Tua"
                                value="{{ old('nama_ortu') }}">
                            @error('nama_ortu')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('nik_ortu') is-invalid @enderror"
                                id="nik_ortu" name="nik_ortu" placeholder="Nik Orang Tua"
                                value="{{ old('nik_ortu') }}">
                            @error('nik_ortu')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
