            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-primary "
                        href="{{ route('SuratDuabelas.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fa fa-file-alt"></i>
                        </div>
                                            ...
                                            @forelse ($surat_duabelas as $surat_duabelas)
                                                <tr>
                                                    ...
                                                    <td class="text-uppercase text-center  font-weight-bolder "><button
                                                            class="btn {{ $surat_duabelas->status == 1 ? 'btn-danger' : 'btn-success' }}"
                                                            disabled>{{ $surat_duabelas->status == 1 ? 'Belum Tercetak' : 'Sudah Tercetak' }}</button>
                                                    </td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_duabelas->nik }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        <a
                                                            href="{{ route('SuratDuabelas.show', ['SuratDuabelas' => $surat_duabelas->id]) }}">{{ $surat_duabelas->nama }}</a>
                                                    </td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_duabelas->keperluan }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_duabelas->no_hp }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        <a href="{{ route('SuratDuabelas.show', ['SuratDuabelas' => $surat_duabelas->id]) }}" title="Detail">
