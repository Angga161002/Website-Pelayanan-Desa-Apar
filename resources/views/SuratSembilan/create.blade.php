                ...
                <form action="{{ route('SuratSembilan.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('provinsi_asal') is-invalid @enderror"
                                id="provinsi_asal" name="provinsi_asal" placeholder="Provinsi Asal"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('kabupaten_asal') is-invalid @enderror"
                                id="kabupaten_asal" name="kabupaten_asal" placeholder="Kabupaten Asal"
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('kecamatan_asal') is-invalid @enderror"
                                id="kecamatan_asal" name="kecamatan_asal" placeholder="Kecamatan Asal"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('kelurahan_asal') is-invalid @enderror"
                                id="kelurahan_asal" name="kelurahan_asal" placeholder="Kelurahan/Desa Asal"
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('dusun_asal') is-invalid @enderror"
                                id="dusun_asal" name="dusun_asal" placeholder="Dusun Asal"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('rw_asal') is-invalid @enderror"
                                id="rw_asal" name="rw_asal" placeholder="RW Asal" value="{{ old('rw_asal') }}">
                            @error('rw_asal')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('rt_asal') is-invalid @enderror"
                                id="rt_asal" name="rt_asal" placeholder="RT Asal" value="{{ old('rt_asal') }}">
                            @error('rt_asal')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select class="form-select" name="dusun_domisili" id="dusun_domisili">
                                    <option disabled selected>--Dusun Domisili--</option>
                                    <option value="ENTHAK" {{ old('dusun_domisili') == 'ENTHAK' ? 'selected' : '' }}>
                                        ENTHAK
                                    </option>
                                    <option value="KARANG_KEMIRI"
                                        {{ old('dusun_domisili') == 'KARANG_KEMIRI' ? 'selected' : '' }}>
                                        KARANG KEMIRI
                                    </option>
                                    <option value="KEMRANGGON"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('rw_domisili') is-invalid @enderror"
                                id="rw_domisili" name="rw_domisili" placeholder="RW Domisili"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('rt_domisili') is-invalid @enderror"
                                id="rt_domisili" name="rt_domisili" placeholder="RT Domisili"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" rows="3"
                            name="keterangan" value="{{ old('keterangan') }}">adalah benar-benar penduduk yang saat ini berdomisili di Dusun...RT...RW... Desa Grujugan Kecamatan Petanahan.</textarea>
                    </div>
                    <div class="form-group">
