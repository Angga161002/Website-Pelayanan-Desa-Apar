                ...
                <form action="{{ route('SuratEnambelas.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('nama_saksisatu') is-invalid @enderror"
                                id="nama_saksisatu" name="nama_saksisatu" placeholder="Nama Saksi Satu"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('nik_saksisatu') is-invalid @enderror"
                                id="nik_saksisatu" name="nik_saksisatu" placeholder="Nik Saksi Satu"
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('nama_saksidua') is-invalid @enderror"
                                id="nama_saksidua" name="nama_saksidua" placeholder="Nama Saksi Kedua"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('nik_saksidua') is-invalid @enderror"
                                id="nik_saksidua" name="nik_saksidua" placeholder="Nik Saksi Kedua"
