            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Data Surat Kelahiran
                        </li>
                    </ol>
                                            ...
                                            @forelse ($surat_empats as $surat_empats)
                                                <tr>
                                                    ...
                                                    <td class="text-uppercase text-center  font-weight-bolder "><button
                                                            class="btn {{ $surat_empats->status == 1 ? 'btn-danger' : 'btn-success' }}"
                                                            disabled>{{ $surat_empats->status == 1 ? 'Belum Tercetak' : 'Sudah Tercetak' }}</button>
                                                    </td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_empats->nik }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        <a
                                                            href="{{ route('SuratEmpat.show', ['SuratEmpat' => $surat_empats->id]) }}">{{ $surat_empats->nama }}</a>
                                                    </td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_empats->saksi_satu }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_empats->saksi_dua }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        {{ $surat_empats->no_hp }}</td>
                                                    <td
                                                        class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                        <a href="{{ route('SuratEmpat.show', ['SuratEmpat' => $surat_empats->id]) }}" title="Detail">
