                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    1</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratSatu.index') }}">Surat Pendaftaran Peristiwa Kependudukan</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                    {{ $jumlah_suratsatu }}</td>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    2</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratDua.index') }}">Surat Pendaftaran Perpindahan Penduduk</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                    {{ $jumlah_suratdua }}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                    <a href="{{ route('SuratEmpat.index') }}">Surat Kelahiran</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    4</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratLima.index') }}">Surat Kematian</a>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    5</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratEnam.index') }}">Surat Keterangan Pengantar</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                                    {{ $jumlah_suratenam }}</td>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    6</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratTujuh.index') }}">Surat Keterangan Ijin Suami/Istri</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    7</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratDelapan.index') }}">Surat Keterangan Usaha</a>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    8</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratSembilan.index') }}">Surat Keterangan Domisili</a>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    9</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratSepuluh.index') }}">Surat Keterangan Kelakuan Baik</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    10</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratSebelas.index') }}">Surat Keterangan Bersih Diri</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    11</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratDuabelas.index') }}">Surat Keterangan Tidak Mampu</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    12</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratTigabelas.index') }}">Surat Keterangan Penghasilan dan Tanggungan Keluarga</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    13</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratEmpatbelas.index') }}">Surat Keterangan Ijin Orang Tua/Wali</a>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    14</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratLimabelas.index') }}">Surat Keterangan Untuk Nikah</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    15</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratEnambelas.index') }}">Surat Pernyataan Belum Menikah</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    16</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratTujuhbelas.index') }}">Surat Pernyataan Belum/Tidak Bekerja</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    17</td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7"><a href="{{ route('SuratDelapanbelas.index') }}">Surat Keterangan Beda Nama</a>
                                                </td>
                                                <td
                                                    class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">
