                ...
                <form action="{{ route('SuratTujuh.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('nik_pasangan') is-invalid @enderror"
                                id="nik_pasangan" name="nik_pasangan" placeholder="Nik Pasangan"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('nama_pasangan') is-invalid @enderror"
                                id="nama_pasangan" name="nama_pasangan" placeholder="Nama Lengkap Pasangan"
