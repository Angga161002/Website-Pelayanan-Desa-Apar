            ...
            <div class="col-md-8 col-xl-6">
                ...
                <form action="{{ route('SuratLimabelas.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="data_pria_wargadesa" id="data_pria_wargadesa" size="1">
                            <option disabled selected>-- Data Calon Pasangan Pria --</option>
                            <option value="WARGA_DESA" {{ old('data_pria_wargadesa') == 'WARGA_DESA' ? 'selected' : '' }}>
                                Warga Desa
                            </option>
                            <option value="LUAR_DESA" {{ old('data_pria_wargadesa') == 'LUAR_DESA' ? 'selected' : '' }}>
                                Warga Luar Desa
                            </option>
                        </select>
                    ...
                    <div id="detail_data_pria_wargadesa" style="display:none;">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_pria_wargadesa" name="nik_pria_wargadesa" placeholder="Nik Pasangan Pria"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_pria_wargadesa" name="nama_pria_wargadesa"
                                    placeholder="Nama Lengkap Pasangan Pria" value="{{ old('nama_pria_wargadesa') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="status_pria_wargadesa" id="status_pria_wargadesa">
                                <option disabled selected>-- Pilih Status Kawin --</option>
                                <option value="JEJAKA" {{ old('status_pria_wargadesa') == 'JEJAKA' ? 'selected' : '' }}>
                                    Jejaka
                                </option>
                                <option value="DUDA" {{ old('status_pria_wargadesa') == 'DUDA' ? 'selected' : '' }}>
                                    Duda
                                </option>
                                <option value="BERISTRI"
                    ...
                    <div id="detail_status_pria_wargadesa" style="display:none;">
                        <div>
                            ...
                            <input type="text"
                                ...
                                id="namaistri_pria_wargadesa" name="namaistri_pria_wargadesa"
                                placeholder="Nama Istri" value="{{ old('namaistri_pria_wargadesa') }}">
                    ...
                    <div id="detail_status_pria_wargadesa_1" style="display:none;">
                        <div>
                            ...
                            <input type="text"
                                ...
                                id="istri_ke_wargadesa" name="istri_ke_wargadesa" placeholder="Istri Keberapa"
                    ...
                    <div id="detail_data_pria_wargadesa_1" style="display:none;">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_pria_wargaluardesa" name="nik_pria_wargaluardesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_pria_wargaluardesa" name="nama_pria_wargaluardesa"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="tempat_lahir_pria_wargaluardesa" name="tempat_lahir_pria_wargaluardesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="tanggal_lahir_pria_wargaluardesa" name="tanggal_lahir_pria_wargaluardesa"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-select" name="warga_negara_pria_wargaluardesa"
                                    id="warga_negara_pria_wargaluardesa">
                                    ...
                                    <option value="DUA_KEWARGANEGARAAN"
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" name="agama_pria_wargaluardesa"
                                    id="agama_pria_wargaluardesa">
                                    ...
                                    <option value="Kepercayaan_Terhadap_Tuhan_YME/Lainnya"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="pekerjaan_pria_wargaluardesa" name="pekerjaan_pria_wargaluardesa"
                        ...
                        <div>
                            ...
                            <input type="text"
                                ...
                                id="alamat_pria_wargaluardesa" name="alamat_pria_wargaluardesa" placeholder="Alamat"
                        ...
                        <div class="form-group">
                            <label for="status_pria_wargaluardesa">Jika pria, terangkan jejaka, duda atau
                                beristri</label>
                            <select class="form-select" name="status_pria_wargaluardesa"
                                id="status_pria_wargaluardesa">
                                <option disabled selected>-- Pilih Status Kawin --</option>
                                <option value="JEJAKA"
                        ...
                        <div id="detail_status_pria_wargaluardesa" style="display:none;">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    id="namaistri_pria_wargaluardesa" name="namaistri_pria_wargaluardesa"
                                    placeholder="Nama Istri" value="{{ old('namaistri_pria_wargaluardesa') }}">
                        ...
                        <div id="detail_status_pria_wargaluardesa_1" style="display:none;">
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    id="istri_ke_wargaluardesa" name="istri_ke_wargaluardesa"
                                    placeholder="Istri Keberapa" value="{{ old('istri_ke_wargaluardesa') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="data_ayahpria_wargadesa" id="data_ayahpria_wargadesa">
                            <option disabled selected>-- Data Ayah Pasangan Pria --</option>
                            <option value="WARGA_DESA"
                                {{ old('data_ayahpria_wargadesa') == 'WARGA_DESA' ? 'selected' : '' }}>
                                Warga Desa
                            </option>
                            <option value="LUAR_DESA"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_ayahpria_wargadesa" name="nik_ayahpria_wargadesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_ayahpria_wargadesa" name="nama_ayahpria_wargadesa"
                    ...
                    <div id="detail_data_ayahpria_wargadesa_1" style="display:none;">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_ayahpria_wargaluardesa" name="nik_ayahpria_wargaluardesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="bin_ayahpria_wargaluardesa" name="bin_ayahpria_wargaluardesa"
                                    placeholder="Bin Ayah Pria" value="{{ old('bin_ayahpria_wargaluardesa') }}">
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_ayahpria_wargaluardesa" name="nama_ayahpria_wargaluardesa"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-select" name="warga_negara_ayahpria_wargaluardesa"
                                    id="warga_negara_ayahpria_wargaluardesa">
                                    <option disabled selected>-- Pilih Warga Negara --</option>
                                    <option value="WNI"
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" name="agama_ayahpria_wargaluardesa"
                                    id="agama_ayahpria_wargaluardesa">
                                    <option disabled selected>-- Pilih Agama --</option>
                                    <option value="ISLAM"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="pekerjaan_ayahpria_wargaluardesa" name="pekerjaan_ayahpria_wargaluardesa"
                        ...
                        <div>
                            ...
                            <input type="text"
                                ...
                                id="alamat_ayahpria_wargaluardesa" name="alamat_ayahpria_wargaluardesa"
                                placeholder="Alamat" value="{{ old('alamat_ayahpria_wargaluardesa') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="data_ibupria_wargadesa" id="data_ibupria_wargadesa">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_ibupria_wargadesa" name="nik_ibupria_wargadesa"
                                    placeholder="Nik Ibu Pria Warga Desa" value="{{ old('nik_ibupria_wargadesa') }}">
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_ibupria_wargadesa" name="nama_ibupria_wargadesa"
                    ...
                    <div id="detail_data_ibupria_wargadesa_1" style="display:none;">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_ibupria_wargaluardesa" name="nik_ibupria_wargaluardesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="binti_ibupria_wargaluardesa" name="binti_ibupria_wargaluardesa"
                                    placeholder="Binti Ibu Pria" value="{{ old('binti_ibupria_wargaluardesa') }}">
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_ibupria_wargaluardesa" name="nama_ibupria_wargaluardesa"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="tempat_lahir_ibupria_wargaluardesa" name="tempat_lahir_ibupria_wargaluardesa"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-select" name="warga_negara_ibupria_wargaluardesa"
                                    id="warga_negara_ibupria_wargaluardesa">
                                    <option disabled selected>-- Pilih Warga Negara --</option>
                                    <option value="WNI"
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" name="agama_ibupria_wargaluardesa"
                                    id="agama_ibupria_wargaluardesa">
                                    <option disabled selected>-- Pilih Agama --</option>
                                    <option value="ISLAM"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="pekerjaan_ibupria_wargaluardesa" name="pekerjaan_ibupria_wargaluardesa"
                        ...
                        <div>
                            ...
                            <input type="text"
                                ...
                                id="alamat_ibupria_wargaluardesa" name="alamat_ibupria_wargaluardesa"
                                placeholder="Alamat" value="{{ old('alamat_ibupria_wargaluardesa') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="data_wanita_wargadesa" id="data_wanita_wargadesa">
                    ...
                    <div id="detail_data_wanita_wargadesa" style="display:none;">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_wanita_wargadesa" name="nik_wanita_wargadesa"
                                    placeholder="Nik Pasangan Wanita" value="{{ old('nik_wanita_wargadesa') }}">
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_wanita_wargadesa" name="nama_wanita_wargadesa"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="status_wanita_wargadesa" id="status_wanita_wargadesa">
                                <option disabled selected>-- Pilih Status Kawin --</option>
                                <option value="PERAWAN"
                    ...
                    <div id="detail_data_wanita_wargadesa_1" style="display:none;">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_wanita_wargaluardesa" name="nik_wanita_wargaluardesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_wanita_wargaluardesa" name="nama_wanita_wargaluardesa"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="tempat_lahir_wanita_wargaluardesa" name="tempat_lahir_wanita_wargaluardesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="tanggal_lahir_wanita_wargaluardesa" name="tanggal_lahir_wanita_wargaluardesa"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-select" name="warga_negara_wanita_wargaluardesa"
                                    id="warga_negara_wanita_wargaluardesa">
                                    <option disabled selected>-- Pilih Warga Negara --</option>
                                    <option value="WNI"
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" name="agama_wanita_wargaluardesa"
                                    id="agama_wanita_wargaluardesa">
                                    <option disabled selected>-- Pilih Agama --</option>
                                    <option value="ISLAM"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="pekerjaan_wanita_wargaluardesa" name="pekerjaan_wanita_wargaluardesa"
                        ...
                        <div>
                            ...
                            <input type="text"
                                ...
                                id="alamat_wanita_wargaluardesa" name="alamat_wanita_wargaluardesa"
                                placeholder="Alamat" value="{{ old('alamat_wanita_wargaluardesa') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="status_wanita_wargaluardesa"
                                id="status_wanita_wargaluardesa">
                                <option disabled selected>-- Pilih Status Kawin --</option>
                                <option value="PERAWAN"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="data_ayahwanita_wargadesa" id="data_ayahwanita_wargadesa">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_ayahwanita_wargadesa" name="nik_ayahwanita_wargadesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_ayahwanita_wargadesa" name="nama_ayahwanita_wargadesa"
                    ...
                    <div id="detail_data_ayahwanita_wargadesa_1" style="display:none;">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_ayahwanita_wargaluardesa" name="nik_ayahwanita_wargaluardesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="bin_ayahwanita_wargaluardesa" name="bin_ayahwanita_wargaluardesa"
                                    placeholder="Bin Ayah Wanita" value="{{ old('bin_ayahwanita_wargaluardesa') }}">
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_ayahwanita_wargaluardesa" name="nama_ayahwanita_wargaluardesa"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-select" name="warga_negara_ayahwanita_wargaluardesa"
                                    id="warga_negara_ayahwanita_wargaluardesa">
                                    <option disabled selected>-- Pilih Warga Negara --</option>
                                    <option value="WNI"
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" name="agama_ayahwanita_wargaluardesa"
                                    id="agama_ayahwanita_wargaluardesa">
                                    <option disabled selected>-- Pilih Agama --</option>
                                    <option value="ISLAM"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="pekerjaan_ayahwanita_wargaluardesa" name="pekerjaan_ayahwanita_wargaluardesa"
                        ...
                        <div>
                            ...
                            <input type="text"
                                ...
                                id="alamat_ayahwanita_wargaluardesa" name="alamat_ayahwanita_wargaluardesa"
                                placeholder="Alamat" value="{{ old('alamat_ayahwanita_wargaluardesa') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="data_ibuwanita_wargadesa" id="data_ibuwanita_wargadesa">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_ibuwanita_wargadesa" name="nik_ibuwanita_wargadesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_ibuwanita_wargadesa" name="nama_ibuwanita_wargadesa"
                    ...
                    <div id="detail_data_ibuwanita_wargadesa_1" style="display:none;">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nik_ibuwanita_wargaluardesa" name="nik_ibuwanita_wargaluardesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="binti_ibuwanita_wargaluardesa" name="binti_ibuwanita_wargaluardesa"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_ibuwanita_wargaluardesa" name="nama_ibuwanita_wargaluardesa"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-select" name="warga_negara_ibuwanita_wargaluardesa"
                                    id="warga_negara_ibuwanita_wargaluardesa">
                                    <option disabled selected>-- Pilih Warga Negara --</option>
                                    <option value="WNI"
                            ...
                            <div class="col">
                                ...
                                <select class="form-select" name="agama_ibuwanita_wargaluardesa"
                                    id="agama_ibuwanita_wargaluardesa">
                                    <option disabled selected>-- Pilih Agama --</option>
                                    <option value="ISLAM"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="pekerjaan_ibuwanita_wargaluardesa" name="pekerjaan_ibuwanita_wargaluardesa"
                        ...
                        <div>
                            ...
                            <input type="text"
                                ...
                                id="alamat_ibuwanita_wargaluardesa" name="alamat_ibuwanita_wargaluardesa"
                                placeholder="Alamat" value="{{ old('alamat_ibuwanita_wargaluardesa') }}">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('nik_walinikah') is-invalid @enderror"
                                id="nik_walinikah" name="nik_walinikah" placeholder="Nik Wali Nikah"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('bin_walinikah') is-invalid @enderror"
                                id="bin_walinikah" name="bin_walinikah" placeholder="Bin"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('nama_walinikah') is-invalid @enderror"
                                id="nama_walinikah" name="nama_walinikah" placeholder="Nama Wali Nikah"
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text"
                                ...
                                id="tempat_lahir_walinikah" name="tempat_lahir_walinikah" placeholder="Tempat Lahir "
                        ...
                        <div class="col">
                            ...
                            <input type="text"
                                ...
                                id="tanggal_lahir_walinikah" name="tanggal_lahir_walinikah"
                                placeholder="Tanggal Lahir" value="{{ old('tanggal_lahir_walinikah') }}">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <select class="form-select" name="warga_negara_walinikah" id="warga_negara_walinikah">
                                <option disabled selected>-- Pilih Warga Negara --</option>
                                <option value="WNI" {{ old('warga_negara_walinikah') == 'WNI' ? 'selected' : '' }}>
                                    WNI
                                </option>
                                <option value="WNA" {{ old('warga_negara_walinikah') == 'WNA' ? 'selected' : '' }}>
                                    WNA
                                </option>
                                <option value="DUA_KEWARGANEGARAAN"
                        ...
                        <div class="col">
                            ...
                            <select class="form-select" name="agama_walinikah" id="agama_walinikah">
                                <option disabled selected>-- Pilih Agama --</option>
                                <option value="ISLAM" {{ old('agama_walinikah') == 'ISLAM' ? 'selected' : '' }}>
                                    ISLAM
                                </option>
                                <option value="KRISTEN" {{ old('agama_walinikah') == 'KRISTEN' ? 'selected' : '' }}>
                                    KRISTEN
                                </option>
                                <option value="KATHOLIK" {{ old('agama_walinikah') == 'KATHOLIK' ? 'selected' : '' }}>
                                    KATHOLIK
                                </option>
                                <option value="HINDU" {{ old('agama_walinikah') == 'HINDU' ? 'selected' : '' }}>
                                    HINDU
                                </option>
                                <option value="BUDHA" {{ old('agama_walinikah') == 'BUDHA' ? 'selected' : '' }}>
                                    BUDHA
                                </option>
                                <option value="KHONGHUCU" {{ old('agama_walinikah') == 'KHONGHUCU' ? 'selected' : '' }}>
                                    KHONGHUCU
                                </option>
                                <option value="Kepercayaan_Terhadap_Tuhan_YME/Lainnya"
                        ...
                        <div class="col">
                            ...
                            <input type="text"
                                ...
                                id="pekerjaan_walinikah" name="pekerjaan_walinikah" placeholder="Pekerjaan "
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control @error('alamat_walinikah') is-invalid @enderror"
                            id="alamat_walinikah" name="alamat_walinikah" placeholder="Alamat"
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control @error('hubungan_walinikah') is-invalid @enderror"
                            id="hubungan_walinikah" name="hubungan_walinikah"
                            placeholder="Hubungan dengan wali nikah" value="{{ old('hubungan_walinikah') }}">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('hari_nikah') is-invalid @enderror"
                                id="hari_nikah" name="hari_nikah" placeholder="Hari Nikah"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('tanggal_nikah') is-invalid @enderror"
                                id="tanggal_nikah" name="tanggal_nikah" placeholder="Tanggal-Bulan-Tahun"
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('jam_nikah') is-invalid @enderror"
                                id="jam_nikah" name="jam_nikah" placeholder="Jam" value="{{ old('jam_nikah') }}">
                            @error('jam_nikah')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control @error('tempat_nikah') is-invalid @enderror"
                            id="tempat_nikah" name="tempat_nikah" placeholder="Tempat Nikah"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="berkas_tambahan_1" id="berkas_tambahan_1">
                            <option disabled selected>-- Surat Keterangan Kematian Suami --</option>
                            <option value="ADA" {{ old('berkas_tambahan_1') == 'ADA' ? 'selected' : '' }}>
                                ADA
                            </option>
                            <option value="TIDAK_ADA" {{ old('berkas_tambahan_1') == 'TIDAK_ADA' ? 'selected' : '' }}>
                                TIDAK ADA
                            </option>
                        </select>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control @error('nama_suami') is-invalid @enderror"
                                    id="nama_suami" name="nama_suami" placeholder="Nama Suami"
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control @error('nik_suami') is-invalid @enderror"
                                    id="nik_suami" name="nik_suami" placeholder="Nik Suami"
                                    value="{{ old('nik_suami') }}">
                                @error('nik_suami')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="tanggal_meninggal_suami" name="tanggal_meninggal_suami"
                                    placeholder="Tanggal-Bulan-Tahun" value="{{ old('tanggal_meninggal_suami') }}">
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="tempat_meninggal_suami" name="tempat_meninggal_suami"
                                    placeholder="Tempat Meninggal" value="{{ old('tempat_meninggal_suami') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="berkas_tambahan_2" id="berkas_tambahan_2">
                            <option disabled selected>-- Surat Keterangan Kematian Istri --</option>
                            <option value="ADA" {{ old('berkas_tambahan_2') == 'ADA' ? 'selected' : '' }}>
                                ADA
                            </option>
                            <option value="TIDAK_ADA" {{ old('berkas_tambahan_2') == 'TIDAK_ADA' ? 'selected' : '' }}>
                                TIDAK ADA
                            </option>
                        </select>
                    ...
                    <div id="detail_berkas_tambahan_2" style="display:none;">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    class="form-control @error('nama_istri') is-invalid @enderror" id="nama_istri"
                                    name="nama_istri" placeholder="Nama Istri" value="{{ old('nama_istri') }}">
                                @error('nama_istri')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col">
                                ...
                                <input type="text" class="form-control @error('nik_istri') is-invalid @enderror"
                                    id="nik_istri" name="nik_istri" placeholder="Nik Istri"
                                    value="{{ old('nik_istri') }}">
                                @error('nik_istri')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="tanggal_meninggal_istri" name="tanggal_meninggal_istri"
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="tempat_meninggal_istri" name="tempat_meninggal_istri"
                                    placeholder="Tempat Meninggal" value="{{ old('tempat_meninggal_istri') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="berkas_tambahan_3" id="berkas_tambahan_3">
                            <option disabled selected>-- Surat Keterangan Pencatatan Isbat --</option>
                            <option value="ADA" {{ old('berkas_tambahan_3') == 'ADA' ? 'selected' : '' }}>
                                ADA
                            </option>
                            <option value="TIDAK_ADA" {{ old('berkas_tambahan_3') == 'TIDAK_ADA' ? 'selected' : '' }}>
                                TIDAK ADA
                            </option>
                        </select>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Tanggal Penetapan" value="{{ old('tanggal_penetapan') }}">
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                    ...
                                    id="pengadilan_agama" name="pengadilan_agama" placeholder="Pengadilan Agama"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="berkas_tambahan_4" id="berkas_tambahan_4">
                            <option disabled selected>-- Surat Keterangan Penanaman Pohon --</option>
                            <option value="ADA" {{ old('berkas_tambahan_4') == 'ADA' ? 'selected' : '' }}>
                                ADA
                            </option>
                            <option value="TIDAK_ADA" {{ old('berkas_tambahan_4') == 'TIDAK_ADA' ? 'selected' : '' }}>
                                TIDAK ADA
                            </option>
                        </select>
                    ...
                    <div id="detail_berkas_tambahan_4" style="display:none;">
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control @error('jenis_pohon') is-invalid @enderror"
                                id="jenis_pohon" name="jenis_pohon" placeholder="Jenis Pohon"
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control @error('lokasi_pohon') is-invalid @enderror"
                                id="lokasi_pohon" name="lokasi_pohon" placeholder="Lokasi Pohon"
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control @error('jumlah_pohon') is-invalid @enderror"
                                id="jumlah_pohon" name="jumlah_pohon" placeholder="Jumlah Pohon"
